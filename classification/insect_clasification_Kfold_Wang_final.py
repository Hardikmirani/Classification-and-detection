...
class Classification:
    ...
    def ann(self, X_train=None, y_train=None, X_test=None, y_test=None):
        ...
        #clf = MLPClassifier(solver='lbfgs', alpha=0.0001, activation ='logistic', max_iter=500,hidden_layer_sizes=(150,60), random_state=1,learning_rate='constant',
       #learning_rate_init=0.001)
       # clf = MLPClassifier(solver='sgd', alpha=0.0001, activation ='logistic', max_iter=500,hidden_layer_sizes=(150,60), random_state=1,learning_rate='constant', learning_rate_init=0.0001)
        ...
        #clf = MLPClassifier(solver='sgd', alpha=0.001, activation ='logistic', max_iter=1000,hidden_layer_sizes=(150,60), random_state=0, learning_rate_init=0.1)
...
def main():
    ...
    try:
        ...
        classes = 5
    directory = ""
    directory= r"Wang shape features\InsectShapeFeaturesResult_Wang 9classes.xlsx"
